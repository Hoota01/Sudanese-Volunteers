              ...
              <div class="box-body">
                <div class="form-group">
                  <select name="to" class="form-control">
                    <?php 
                    $sql = "SELECT * FROM apply_post INNER JOIN users ON apply_post.id_user=users.id_user WHERE apply_post.id_company='$_SESSION[id_company]' AND apply_post.status='2'";
