...
if(isset($_POST)) {
		...
		if(file_exists($_FILES['image']['tmp_name'])) { 
			...
			if($imageFileType == "jpg" || $imageFileType == "png")  {
				...
				if($_FILES['image']['size'] < 500000) { // File size is less than 5MB
					...
					header("Location: edit-organaization.php");
					exit();
				}
			} else {
	...
	$sql = "UPDATE Organizations SET companyname='$companyname', website='$website', city='$city', state='$state', contactno='$contactno', aboutme='$aboutme'";
