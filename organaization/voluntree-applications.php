      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="voluntree-applications.php"><i class="fa fa-file-o"></i> Volunteer requests</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <?php
             $sql = "SELECT * FROM posts INNER JOIN apply_post ON posts.id_jobpost=apply_post.id_jobpost  INNER JOIN users ON users.id_user=apply_post.id_user WHERE apply_post.id_company='$_SESSION[id_company]'";
