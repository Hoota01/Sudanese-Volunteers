        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <div class="row margin-top-20">
              <div class="col-md-12">
              <?php
               $sql = "SELECT * FROM posts WHERE id_company='$_SESSION[id_company]' AND id_jobpost='$_GET[id]'";
              ...
              <h3><i class="fa-solid fa-location-dot"></i> location :<?php echo $row['locations']; ?></h3>
                ...
                <div class="pull-right">
                  <a href="my-posts.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
                </div>
