...
$sql = "SELECT * FROM apply_post WHERE id_company='$_SESSION[id_company]' AND id_user='$_GET[id]'";
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-posts.php"><i class="fa fa-file-o"></i> My Post</a></li>
              ...
              <?php
               $sql = "SELECT * FROM users WHERE id_user='$_GET[id]'";
                ...
                <div class="pull-right">
                  <a href="voluntree-applications.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
                </div>
