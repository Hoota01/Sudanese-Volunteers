...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO posts(id_company, jobtitle, description, minimumsalary, maximumsalary, experience, qualification, gender, locations) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("isssssss", $_SESSION['id_company'], $jobtitle, $description, $minimumsalary, $maximumsalary, $experience, $qualification, $gender, $locations);
