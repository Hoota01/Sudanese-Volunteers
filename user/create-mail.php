              ...
              <div class="box-body">
                <div class="form-group">
                  <select name="to" class="form-control">
                    <?php 
                    $sql = "SELECT * FROM apply_post INNER JOIN organizations ON apply_post.id_company=organizations.id_company WHERE apply_post.id_user='$_SESSION[id_user]' AND apply_post.status='2'";
