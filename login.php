...
<body class="hold-transition skin-green sidebar-mini" id="log">
<div class="wrapper">
  ...
  <div class="content-wrapper" style="margin-left: 0px;"  id="logo">

    <section class="content-header" >
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20" id="sig">
          <h1 class="text-center margin-bottom-20 " >WELCOME</h1>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-5">
              <div class="inner">
                <h3 class="text-center">Volunteers </h3>
              </div>
              <a href="login-voluntree.php" class="small-box-footer">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              ...
              <a href="login-organaizations.php" class="small-box-footer">
                Login <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
