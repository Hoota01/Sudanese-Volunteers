...
<div class="login-box">
  ...
  <a href="index.php"><img src="img/icon.png" class="img-responsive"></a>
  </div>
    <p class="login-box-msg">Organization Login</p>

    <form method="post" action="CheckOrganaizationsLogin.php">
      ...
      <div class="row">
        ...
        <div class="col-xs-8">
        <a href="register-organaizations.php">Create New Account!</a>
        </div>
