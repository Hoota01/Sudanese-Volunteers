   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">CREATE ORGANIZATION PROFILE</h1>
          <form method="post" id="registerCompanies" action="addorganaizations.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="name" placeholder="Full Name" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="companyname" placeholder="Organization Name" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4" name="aboutme" placeholder="Brief info about your Organization"></textarea>
              </div>
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <label>Attach organization Logo</label>
