        ...
        <div class="row latest-job margin-top-50 margin-bottom-20" id="sig">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-yellow padding-5">
              ...
              <a href="register-voluntrees.php" class="small-box-footer">
              Registration <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-md-6 latest-job ">
            <div class="small-box bg-red padding-5">
              ...
              <a href="register-organaizations.php" class="small-box-footer">
              Registration <i class="fa fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
