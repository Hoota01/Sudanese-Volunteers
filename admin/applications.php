            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="active-voluntree_Opportunities.php"><i class="fa fa-briefcase"></i> Active Volunteer opportunity</a></li>
                  <li class="active"><a href="applications.php"><i class="fa fa-address-card-o"></i> Volunteer</a></li>
